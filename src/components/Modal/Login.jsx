    ...
    <div>
      ...
      >
        ...
        >
                ...
                {new Array(length).fill("").map((_, i) => (
                  <span
                    ...
                    className={`block h-2 w-2 rounded-full ${
                      activeIndex === i ? "bg-teal-300" : "bg-gray-300"
                    }`}
          ...
          >
            {[guitar, love, avatar].map((img, index) => (
              <div
                key={index}
        ...
        >
          <div className="p-6 pt-0">
            ...
            <div className="pt-5 flex-col items-center justify-center">
              <p className="font-semibold text-sm">OR</p>
              <p className="font-bold text-sm pt-3 underline underline-offset-4">
                Login With Email
              </p>
            </div>
            <div className="pt-10 sm:pt-20 flex-col items-center justify-center">
              <p className="text-xs">
