...
const Navbar = (props) => {
  ...
  return (
    <div>
      <nav className="fixed z-50 w-full overflow-auto p-2 pl-3 shadow-md bg-slate-100 border-b-4 border-solid border-b-white">
        ...
        <div className="relative location-search ml-5">
          ...
          <input
            ...
            type="text"
            className="w-[50px] sm:w-[150px] md:w-[250px] lg:w-[270px] p-3 pl-8 border-black border-2 rounded-md placeholder:text-ellipsis focus:outline-none focus:border-teal-300"
          />
          <img
            src={arrow}
            alt=""
